...
export function AboutSection() {
  return (
    <section className="relative flex w-full shrink-0 flex-col items-center justify-center overflow-hidden bg-cream px-4 py-12 md:h-[800px] md:px-0 md:py-0">
      <Image
      ...
      <div className="relative z-10 flex w-full max-w-[1340px] flex-col items-center gap-8 md:hidden">
        <RevealMedia className="relative aspect-[357/521] w-full max-w-[357px] overflow-hidden rounded">
          <Image
            src="/images/about-portrait.png"
            alt="Eve Jean in a kitchen"
            fill
            className="object-cover"
            sizes="(max-width: 768px) 90vw, 357px"
          />
        </RevealMedia>

        <div className="flex max-w-[563px] flex-col items-center gap-3 text-center leading-[1.2]">
          <h2 className="font-display text-[28px] uppercase text-ink sm:text-[32px]">
            Every space begins as an idea. Craft is what makes it feel true.
          </h2>
          <p className="font-[family-name:var(--font-instrument)] text-base text-[rgba(21,21,21,0.8)] sm:text-lg">
        ...
        <RevealMedia
          className="relative aspect-[357/521] w-full max-w-[357px] overflow-hidden rounded"
          delayMs={160}
        >
          <video
        ...
        <div className="flex w-full max-w-[242px] flex-col items-center">
          <Signature />
          <p className="mt-1 text-center font-[family-name:var(--font-instrument)] text-base leading-[1.2] text-[rgba(21,21,21,0.8)] sm:text-lg">
            Founder & Creative Director
          </p>
        </div>
      </div>

      <div className="relative z-10 hidden h-[663px] w-full max-w-[1340px] md:block">
